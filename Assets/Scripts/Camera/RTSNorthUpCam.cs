...
namespace Camera
{
    public class RTSNorthUpCam : MonoBehaviour
    {
        ...
        [SerializeField] private UnityEngine.Camera mainCamera; // Reference to the main camera for raycasting
        ...
        void SetNavMeshDestination()
        {
            ...
            UnityEngine.Camera cameraToUse = mainCamera;
            if (cameraToUse == null)
            {
                cameraToUse = UnityEngine.Camera.main; // Fallback to main camera
            }
